...
Medion has retired their old Robots app and the backend API endpoints do not return data anymore. Use Tuya Local (https://github.com/make-all/tuya-local) with official Tuya mobile app instead to get the device local key.
